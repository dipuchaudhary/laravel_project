    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('emp_insert1') }}">
                        @csrf
        ...
        @foreach($second as $seconds)
            <tr>
               <!--  <td>
                ...
                <td>
                	<a class="btn btn-primary" href="{{url('edit')}}/{{$seconds->id}}">Edit</a>
                    <button onclick="view('{{ $seconds-> id}}')" class="btn btn-primary">View</button>
                    <a class="btn btn-danger" href="{{url('delete')}}/{{$seconds->id}}">Delete</a>
                </td>

    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('emp_insert4') }}">
                        @csrf
        ...
        @foreach($fifth as $fifths)
            <tr>
               <!--  <td>
                ...
                <td>
                    <a class="btn btn-primary" href="{{url('edit4')}}/{{$fifths->id}}">Edit</a>
                    <button onclick="view('{{ $fifths-> id}}')" class="btn btn-primary">View</button>
                    <a class="btn btn-danger" href="{{url('delete')}}/{{$fifths->id}}">Delete</a>
                </td>

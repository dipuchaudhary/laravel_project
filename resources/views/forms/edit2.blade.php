                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('emp_update') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="emp_name" type="text" class="form-control{{ $errors->has('emp_name') ? ' is-invalid' : '' }}" name="emp_name" value="{{$third->emp_name }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control{{ $errors->has('emp_email') ? ' is-invalid' : '' }}" name="emp_email" value="{{ $third->emp_email }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="emp_type" type="text" class="form-control{{ $errors->has('emp_type') ? ' is-invalid' : '' }}" name="emp_type" value="{{ $third->emp_type}}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="emp_id" type="number" class="form-control" name="emp_id"  value="{{ $third->emp_id}}" required>
                            </div>
                        </div>
        ...
        @foreach($third1 as $third1s)
            <tr>
               <!--  <td>
                ...
                <td>
                	<a class="btn btn-primary" href="{{url('edit2')}}/{{$third1s->id}}">Edit</a>
                </td>
